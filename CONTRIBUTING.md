...
For security vulnerabilities, please follow our [Security Policy](https://github.com/revenium/revenium-middleware-perplexity-node/blob/HEAD/SECURITY.md) - do not create public issues.
